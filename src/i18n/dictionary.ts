...
export const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    appWinDesc: 'From the Microsoft Store, or download the installer directly from GitHub Releases.',
    appWinReq: 'Windows 10/11 · 64-bit',
    appWinBtn: 'Get from Microsoft Store',
    appWinDirect: 'Or download the installer directly from GitHub Releases',
    ...
    footerPrivacyRemoter: 'Remoter Privacy',
    footerContact: 'Contact',
    footerPoweredBrand: 'Juicy Player',
